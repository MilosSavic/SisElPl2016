...
call xcopy /s /y "%~dp0\AcquirerBankWS\target\AcquirerBankWS.jar" "%~dp0\Deploy"
call xcopy /s /y "%~dp0\AcquirerBankWS\src\main\resources\acquirer.jks" "%~dp0\Deploy\keystore"
...
call xcopy /s /y "%~dp0\PaymentCardCenterWS\target\PaymentCardCenterWS.jar" "%~dp0\Deploy"
call xcopy /s /y "%~dp0\PaymentCardCenterWS\src\main\resources\pcc.jks" "%~dp0\Deploy\keystore"
...
call xcopy /s /y "%~dp0\IssuerBankWS\target\IssuerBankWS.jar" "%~dp0\Deploy"
call xcopy /s /y "%~dp0\IssuerBankWS\src\main\resources\issuer.jks" "%~dp0\Deploy\keystore"
